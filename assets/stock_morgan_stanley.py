import json
import requests
from assets.common import WorkStockBase, convert_usd_to_ils, print_value, HEADERS_USER_AGENT
...
class MorganStanleyStockPlanConnect(WorkStockBase):
    ...
    def _establish_session(self, username, password):
        ...
        s.post(self.LOGIN_URL, data=post_data, headers=HEADERS_USER_AGENT)
        return s
